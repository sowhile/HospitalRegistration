...
<span :onclick="'javascript:window.location=\'/hosp/'+hospital.hoscode+'\''"
      class="v-link selected dark">预约挂号 </span>
      </div>
      <div class="nav-item ">
        <span :onclick="'javascript:window.location=\'/hosp/detail/'+hospital.hoscode+'\''"
              class="v-link clickable dark"> 医院详情 </span>
      </div>
      <div class="nav-item">
        <span :onclick="'javascript:window.location=\'/hosp/notice/'+hospital.hoscode+'\''"
