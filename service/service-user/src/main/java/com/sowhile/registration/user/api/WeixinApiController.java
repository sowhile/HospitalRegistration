...
import com.sowhile.registration.user.util.ConstantPropertiesUtil;
import com.sowhile.registration.user.util.HttpClientUtils;
...
//            log.error("非法回调请求");
            throw new RegistrationException(ResultCodeEnum.ILLEGAL_CALLBACK_REQUEST_ERROR);
        }
        ...
        try {
            ...
            throw new RegistrationException(ResultCodeEnum.FETCH_ACCESSTOKEN_FAILD);
        }
